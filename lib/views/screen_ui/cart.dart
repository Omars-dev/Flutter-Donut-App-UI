                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: secondaryButtonColor,
                      boxShadow: [
                        BoxShadow(
                          color: mainButtonColor.withOpacity(0.4), // Shadow color
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: const [
                          Text('\$285.00',style:TextStyle(fontWeight: w600,color: Colors.black,fontSize: 16)),
                          SizedBox(height:5),
                          Text('Total 4 items',style:TextStyle(fontWeight: w500,color: greyText,fontSize: 12)),
                        ],
                      ),
                      GestureDetector(
                        onTap: (){
                        ...
                        child: Container(
                          ...
                          child: const Text('Checkout',style:TextStyle(fontWeight: w600,color: Colors.white,fontSize: 16)),
                        ),
                      )
                    ],
                  ),
